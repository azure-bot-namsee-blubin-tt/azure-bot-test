...
export class JiraBot extends AgentApplication {
  ...
  _welcome = async context => {
    ...
    const welcomeMessage = [
      ...
      "      <li style='margin-bottom: 10px;'><code><b>jira create</b></code> — Create a new Jira ticket</li>",
      "      <li style='margin-bottom: 10px;'><code><b>jira my tickets</b></code> — View your assigned tickets</li>",
      "      <li style='margin-bottom: 10px;'><code><b>jira search &lt;query&gt;</b></code> — Search for tickets</li>",
      "      <li style='margin-bottom: 10px;'><code><b>jira view &lt;KEY-123&gt;</b></code> — View ticket details</li>",
      "    </ul>",
      "  </div>",
      "",
      "  <div style='margin-bottom: 25px;'>",
      ...
      "    </div>",
      "    <ul style='margin-top: 10px; padding-left: 20px;'>",
      "      <li style='margin-bottom: 10px;'><code><b>itsm create</b></code> — Create a new ITSM request</li>",
      "      <li style='margin-bottom: 10px;'><code><b>itsm forms</b></code> — Show available form templates</li>",
      "      <li style='margin-bottom: 10px;'><code><b>itsm debug</b></code> — Debug fields info</li>",
      "    </ul>",
      "  </div>",
      "",
      "  <hr style='border: 0; border-top: 1px solid #000000;'>",
