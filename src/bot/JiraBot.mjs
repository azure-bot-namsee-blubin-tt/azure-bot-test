...
export class JiraBot extends AgentApplication {
  ...
  _welcome = async context => {
    ...
    const welcomeMessage = [
      ...
      "      <img src='https://stsharedservicemain001.blob.core.windows.net/itsm/jira.svg' style='margin-right: 5px; vertical-align: middle;'>",
      ...
      "  <div style='margin-bottom: 25px;'>",
      "    <div style='display: flex; align-items: center;'>",
      "      <img src='https://stsharedservicemain001.blob.core.windows.net/itsm/jira-sm.svg' style='margin-right: 5px; vertical-align: middle;'>",
